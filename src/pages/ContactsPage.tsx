...
import { Search, Download, ChevronDown, ChevronUp, ExternalLink, Mail, Globe, Linkedin } from "lucide-react";
              ...
              {expandedId === contact.id && (
                <div className="bg-card border border-t-0 border-border rounded-b-xl px-4 pb-4 space-y-3 -mt-1">
                  ...
                  {contact.linkedin_url && (
                    <a href={contact.linkedin_url.startsWith("http") ? contact.linkedin_url : `https://${contact.linkedin_url}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-primary">
                      <Linkedin className="h-3.5 w-3.5" />
                      LinkedIn
                    </a>
                  )}
                  {contact.company_website && (
                    <a href={contact.company_website.startsWith("http") ? contact.company_website : `https://${contact.company_website}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-primary">
